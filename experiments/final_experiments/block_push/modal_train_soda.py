...
TASK         = "block_push"
# Data lives on the volume (generated by modal_generate_block_push.py)
ZARR_OVERRIDE = "task.dataset.zarr_path=/experiments/data/raw/block_push/block_push.zarr"
...
def main(
    ...
    # Always inject zarr path pointing to volume data
    overrides = [ZARR_OVERRIDE] + ([p for p in hydra_overrides.split() if p.strip()] if hydra_overrides else [])
